...
const ja: Translations = {
    ...
    infoPanel: {
        ...
        news: {
            updates: [
                {
                    title: 'サーバーパフォーマンス最適化 (2024.03.14)',
                    items: [
                        'リクエスト合体 — 同エリアへの同時リクエストをAPI呼び出し1回に統合',
                        'API別空間解像度に合わせたグリッドキャッシュ導入（5km〜55km単位）',
                        'GK2A衛星HDF5ダウンロード共有 — 27MBファイルの重複ダウンロードを排除',
                        '7件のバグ修正: NaN伝播遮断、nullキャッシュ汚染防止、スコアリング安定化',
                        'Circuit Breakerパターンで障害APIの自動隔離と復旧',
                    ],
                },
                {
                    title: '予報信頼性向上',
