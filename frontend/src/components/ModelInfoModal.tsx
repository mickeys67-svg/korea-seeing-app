...
const ModelInfoModal: React.FC<ModelInfoModalProps> = ({ isOpen, onClose }) => {
    ...
    const content = {
        en: {
            ...
            feature4_text: "Cross-references multiple atmospheric data streams for higher confidence predictions.",
        ...
        kr: {
            ...
            feature4_text: "다중 기상 데이터 스트림을 교차 검증하여 높은 신뢰도의 예측을 제공합니다.",
            guide_title: "관측 가이드",
